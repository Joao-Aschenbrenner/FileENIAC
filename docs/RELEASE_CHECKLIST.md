...
|----------|----------|------|--------|
| Windows Installer (NSIS) | `apps/desktop/src-tauri/target/release/bundle/nsis/FileENIAC_0.1.2_x64-setup.exe` | TBD | TBD |
| Source tarball | GitHub release source archive | — | TBD |
